...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2 = ObjectAnimator.ofFloat(target, "scaleX",
                1.0f, 2.0f);
        ...
        ObjectAnimator animator3 = ObjectAnimator.ofFloat(target, "scaleY",
                1.0f, 2.0f);
        ...
        ObjectAnimator animator4 = ObjectAnimator.ofFloat(target, "alpha",
                1f, 0.5f);
