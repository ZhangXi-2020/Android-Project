...
//import com.byted.camp.todolist.ClockManager;
//import com.byted.camp.todolist.ClockReceiver;
//import com.byted.camp.todolist.ClockService;
...
//    private ClockManager mClockManager = ClockManager.getInstance();
    ...
    public NoteViewHolder(@NonNull View itemView, NoteOperator operator) {
        ...
        remindText = itemView.findViewById(R.id.remind_time);
...
//    }
    ...
    public void bind(final Note note) {
        ...
        dateText.setText("Create Time:  " + SIMPLE_DATE_FORMAT.format(note.getDate()));
        remindText.setText("Remind Time: " + SIMPLE_DATE_FORMAT.format(note.getRemind()));
